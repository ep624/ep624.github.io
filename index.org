...
+ Updating your analysis, for example when new data become available, is easy, as the same program could be run on new data to get new results.
...
#+INCLUDE: "~/vikascloud/orgpaper/orgpapers.org::orgmodebasics" :only-contents t


**  Org-babel and writing R source code in Org
